...
export const chapters: Chapter[] = [
  {
    ...
    description: 'Completed secondary education at Kendriya Vidyalaya 1 STC (Jabalpur) with a strong foundation in science and mathematics including all subjects like English and Social Science.',
    longDescription: 'I completed my schooling at Kendriya Vidyalaya 1 STC, where I built a strong foundation in mathematics and science. During this time, I developed a growing interest in computer science and problem-solving, which motivated me to pursue technology and development further.',
    chapterNumber: 1,
  ...
  },
  {
    ...
    year: '2022-2023',
    phase: 'Gap year',
    title: 'Preparing for the JEE Advance',
    description: 'Preparing for the JEE Advance and decided to take a gap year for better preparation.',
    longDescription: 'During this gap year, I devoted myself to rigorous preparation for the Joint Entrance Examination (JEE) Advanced. It was a period of intense focus, self-discipline, and resilience. I worked on strengthening my fundamentals in Physics, Chemistry, and Mathematics, solving thousands of problems to build speed and accuracy. This year taught me the value of consistency and the importance of a structured approach to complex challenges.',
    chapterNumber: 3,
    publishedDate: 'May 2023',
    author: 'Ravi Kumar',
    tags: ['PCM', 'Intermediate', 'Board Exams'],
  ...
  },
  {
    id: '5',
    year: '2023',
    phase: 'First Breakthrough In IOT',
    title: 'Cyber Physics IOT Lab',
    description: 'Semester 1 Cyber Physics IOT Lab, where I got the opportunity to work on real-world IoT projects and developed my skills in hardware and software development. The first project was a Smart parking system',
    longDescription: 'My first real breakthrough in technology came through the Cyber Physics IoT Lab during Semester 1. Working on hands-on IoT projects introduced me to the connection between hardware and software systems. From building a smart parking system to understanding sensors, microcontrollers, and automation concepts, this experience strengthened my problem-solving mindset and sparked a deeper interest in real-world tech innovation and embedded systems development.',
    chapterNumber: 5,
    publishedDate: 'September 2023',
    author: 'Ravi Kumar',
    tags: ['Progamming', 'C Language', 'IOT application'],
    status: 'Completed',
    coverImage: '/projects/calculator.png',
    iconName: 'code',
    accent: '#8B5CF6',
    ...
    rotation: 1,
    size: 'normal',
    readingContent: 'Joining the Cyber Physics IoT Lab in my first semester was one of the most exciting experiences of my college journey. For the first time, I got to work on projects that connected software with real-world hardware. Building a Smart Parking System taught me how sensors, microcontrollers, and automation work together to solve practical problems. I explored Arduino programming, basic circuit design, and IoT communication concepts while learning how to debug both hardware and software issues. Every small success — from making sensors respond correctly to seeing the system work in real time — boosted my confidence and deepened my interest in innovation and smart technologies.'
  },
  {
    id: '5',
    year: '2024',
